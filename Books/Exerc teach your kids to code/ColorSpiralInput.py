#SpyralMyName.py - prints a colorful spiral of the user´s name

import turtle       #Set up the turtle graphics
t = turtle.Pen()
...
#Draw a colorful spira with the user-specified number of sides
for x in range(360):
    ...
    t.left(360 / sides + 1)             #Turn 360 degress / mumber of sides, plus 1
